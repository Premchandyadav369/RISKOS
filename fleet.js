...
(() => {
  ...
  // ══════════════════════════════════════════════════════════════════════════
    ...
    // ══════════════════════════════════════════════════════════════════════════
    {
      ...
      mythName: 'RA',
      mythIcon: '☀️',
      mythTitle: 'Supreme Sun God of Radiant Alpha & Solar Momentum',
      primarySymbol: 'NIFTY',
      displayAsset: 'NIFTY 24680 CE/PE',
      venue: 'NSE PRISM',
      basePrice: 24687.5,
      currentPrice: 24687.5,
      dailyVolume: '₹48,200 Cr',
      minuteVolume: '21,400 Lots',
      evalSpeedSec: 4,
      strategyType: 'Solar Momentum Volatility Dispersion',
      mathFormula: String.raw`\text{Dispersion} = \sigma_{\text{Index}} - \sum_{i=1}^N w_i \sigma_i \cdot \sqrt{1 - \bar{\rho}}`,
      tier: 'S-TIER',
      sentimentSource: 'Options 25Δ Risk Reversal & Solar Cycle Skew',
      sentimentScore: +0.48,
      sentimentRegime: 'SOLAR_EXPANSION',
      sentimentSignal: 'Implied correlation elevated (0.68); harvesting index variance premium while buying undervalued single-stock wing convexity.',
      allocatedCapINR: 1600000,
      baseDailyAlphaINR: 2750,
      realizedPnlINR: 68200,
      winRate: 79.2,
      tradesToday: 36,
      sharpe: 3.28,
      profitFactor: 3.05,
      maxDD: -0.55,
      laymanExplanation: 'Exploits the price difference between overall index volatility and individual stock movements under the supreme power of solar momentum.',
      mathDerivation: String.raw`\Pi_{\text{dispersion}} = \text{Vega}_{\text{index}} \Delta \sigma_{\text{index}} - \sum w_i \text{Vega}_i \Delta \sigma_i`,
      entryRules: 'Enter when Index IV exceeds constituent basket IV by > 3.8 vol points.',
      exitRules: 'Take profit at 60% max theta decay or stop at 1.7x entry credit.',
      crisisReplay: 'Generated +18.4% during 2024 global equity volatility spike.'
    },
    {
      id: 'BOT-EG-IN-02',
      market: 'india',
      ...
      mythName: 'ANUBIS',
      mythIcon: '⚖️',
      mythTitle: 'Guardian of the Scales & Credit Default Arbitrage',
      primarySymbol: 'HDFCBANK.NS',
      displayAsset: 'HDFCBANK / ICICIBANK / SBIN',
      venue: 'NSE COLOCATION',
      basePrice: 1642.0,
      currentPrice: 1642.0,
      dailyVolume: '₹2,450 Cr',
      minuteVolume: '36,500 Shares',
      evalSpeedSec: 6,
      strategyType: 'Credit Spread Cointegration Arb',
      mathFormula: String.raw`\text{Spread}_t = \ln(P_{\text{HDFC}}) - \beta_t \ln(P_{\text{ICICI}}) - \gamma_t \ln(P_{\text{SBI}})`,
      tier: 'S-TIER',
      sentimentSource: 'Credit Default Swap Spreads & Repo Transmission',
      sentimentScore: +0.32,
      sentimentRegime: 'WEIGHED_EQUILIBRIUM',
      sentimentSignal: 'Kalman residual weighed on Anubis scales (+2.4σ); buying HDFC while hedging across ICICI and SBI.',
      allocatedCapINR: 1350000,
      baseDailyAlphaINR: 2150,
      realizedPnlINR: 46400,
      winRate: 82.5,
      tradesToday: 22,
      sharpe: 3.62,
      profitFactor: 3.35,
      maxDD: -0.38,
      laymanExplanation: 'Weighs banking giant valuations on the sacred scales of justice. Buys high-quality banks when temporarily mispriced against state peers.',
      mathDerivation: String.raw`\mathbf{x}_t = \mathbf{F}_t \mathbf{x}_{t-1} + \mathbf{w}_t, \quad \mathbf{z}_t = \mathbf{H}_t \mathbf{x}_t + \mathbf{v}_t`,
      entryRules: 'Enter triad banking basket when cointegration error exceeds 2.2 standard deviations.',
      exitRules: 'Exit upon reversion to mean (error < 0.25σ) or 7-day timeout.',
      crisisReplay: 'Zero systemic default loss during the 2023 US regional banking crisis.'
    },
    {
      id: 'BOT-EG-IN-03',
      market: 'india',
      ...
      mythName: 'THOTH',
      mythIcon: '📜',
      mythTitle: 'God of Sacred Mathematics & Algorithmic Calculation',
      primarySymbol: 'TCS.NS',
      displayAsset: 'TCS / INFY / HCLTECH',
      venue: 'NSE PRISM',
      basePrice: 4480.0,
      currentPrice: 4480.0,
      dailyVolume: '₹1,850 Cr',
      minuteVolume: '19,200 Shares',
      evalSpeedSec: 5,
      strategyType: 'Hieroglyphic Fibonacci Autoregression',
      mathFormula: String.raw`\hat{P}_{t+h} = \sum_{k=1}^p \phi_k P_{t-k} + \sum_{m \in \mathcal{F}} \alpha_m \cdot \text{Fib}_m(H_t, L_t)`,
      tier: 'A-TIER',
      sentimentSource: 'Enterprise Generative AI CapEx & Deal TCV Flow',
      sentimentScore: +0.65,
      sentimentRegime: 'HIEROGLYPHIC_TREND',
      sentimentSignal: 'TCV deal pipeline acceleration (+0.65); pyramiding long exposure at the 61.8% golden ratio retracement level.',
      allocatedCapINR: 1100000,
      baseDailyAlphaINR: 1580,
      realizedPnlINR: 35800,
      winRate: 71.0,
      tradesToday: 16,
      sharpe: 2.58,
      profitFactor: 2.45,
      maxDD: -0.98,
      laymanExplanation: 'Applies sacred mathematical ratios and time-series autoregression to anticipate where global IT leaders will find institutional support.',
      mathDerivation: String.raw`\phi = \frac{1 + \sqrt{5}}{2} \approx 1.618, \quad P_{\text{target}} = P_0 + \phi^n \cdot \text{ATR}`,
      entryRules: 'Enter long on bounce from 38.2% or 61.8% Fibonacci level with rising volume.',
      exitRules: 'Trailing profit lock at 161.8% extension or trailing 14-day ATR stop.',
      crisisReplay: 'Protected capital during 2022 US tech rate repricing via golden-ratio trailing stops.'
    },
    {
      id: 'BOT-EG-IN-04',
      market: 'india',
      ...
      mythName: 'SOBEK',
      mythIcon: '🐊',
      mythTitle: 'Lord of the Nile Surge, Current & Raw Petrochemical Power',
      primarySymbol: 'RELIANCE.NS',
      displayAsset: 'RELIANCE / ONGC Spot & Futures',
      venue: 'NSE PRISM',
      basePrice: 3010.5,
      currentPrice: 3010.5,
      dailyVolume: '₹3,200 Cr',
      minuteVolume: '52,000 Shares',
      evalSpeedSec: 8,
      strategyType: 'Petrochemical Nile Basis Arbitrage',
      mathFormula: String.raw`\text{Basis}_{\text{Nile}} = \frac{F_t - S_t}{S_t} \cdot \frac{365}{D} - r_{\text{repo}} - \text{Storage}`,
      tier: 'S-TIER',
      sentimentSource: 'Singapore Gross Refining Margin & Brent Forward Curve',
      sentimentScore: +0.55,
      sentimentRegime: 'NILE_SURGE_CARRY',
      sentimentSignal: 'Refining crack margins widening (+0.55); locking in 10.2% annualized cash-and-carry basis spread.',
      allocatedCapINR: 1500000,
      baseDailyAlphaINR: 1850,
      realizedPnlINR: 32100,
      winRate: 93.5,
      tradesToday: 14,
      sharpe: 4.25,
      profitFactor: 5.10,
      maxDD: -0.22,
      laymanExplanation: 'Lies in wait like the crocodile of the Nile. When futures basis spikes, locks in guaranteed annualized carry yield while holding physical shares.',
      mathDerivation: String.raw`F_t = S_t e^{(r + u - y)T}, \quad \Delta_{\text{hedge}} = -1.0 \cdot \text{ContractSize}`,
      entryRules: 'Enter when annualized cost-of-carry spread exceeds RBI repo rate + 300 bps.',
      exitRules: 'Hold to contract expiry convergence on monthly settlement Thursday.',
      crisisReplay: 'Zero directional equity exposure; gained +11.8% annualized through 2022 crude shock.'
    },
    {
      id: 'BOT-EG-IN-05',
      market: 'india',
      ...
      mythName: 'SEKHMET',
      mythIcon: '🦁',
      mythTitle: 'Warrior Lioness of Ferocious Momentum Breakouts',
      primarySymbol: 'TATAMOTORS.NS',
      displayAsset: 'TATAMOTORS / MARUTI / M&M',
      venue: 'NSE COLOCATION',
      basePrice: 985.2,
      currentPrice: 985.2,
      dailyVolume: '₹1,640 Cr',
      minuteVolume: '34,200 Shares',
      evalSpeedSec: 3,
      strategyType: 'High-Velocity Breakout Scalping',
      mathFormula: String.raw`\text{Signal} = \mathbb{I}\left(P_t > \max_{20}(H)\right) \cdot \left(\frac{\text{Volume}_t}{\text{ADV}_{20}} \ge 1.8\right)`,
      tier: 'S-TIER',
      sentimentSource: 'Monthly Automotive Registration VAHAN Portal & EV Adoption',
      sentimentScore: +0.72,
      sentimentRegime: 'LIONESS_FURY_MOMENTUM',
      sentimentSignal: 'Commercial vehicle registrations surging (+0.72); buying high-volume channel breakout with dynamic trailing chandelier.',
      allocatedCapINR: 900000,
      baseDailyAlphaINR: 1720,
      realizedPnlINR: 24800,
      winRate: 75.5,
      tradesToday: 26,
      sharpe: 2.95,
      profitFactor: 2.75,
      maxDD: -0.68,
      laymanExplanation: 'Attacks breakout stocks with the ferocity of a lioness. Catches explosive multi-day surges in auto and EV leaders with heavy volume confirmation.',
      mathDerivation: String.raw`\text{Exit}_{\text{Chandelier}} = \max_{22}(P) - 2.8 \cdot \text{ATR}_{22}`,
      entryRules: 'Enter long when price breaks 20-day high with RVOL ≥ 1.8x and positive order flow imbalance.',
      exitRules: 'Trailing ATR chandelier stop or take 60% profit at +3R milestone.',
      crisisReplay: 'Protected profits with rapid trailing stop during 2020 auto supply disruption.'
    },
    {
      id: 'BOT-EG-IN-06',
      market: 'india',
      ...
      mythName: 'ISIS',
      mythIcon: '🪽',
      mythTitle: 'Goddess of Healing, Regeneration & Asymmetric Event Alpha',
      primarySymbol: 'SUNPHARMA.NS',
      displayAsset: 'SUNPHARMA / DRREDDY / CIPLA',
      venue: 'NSE PRISM',
      basePrice: 1820.0,
      currentPrice: 1820.0,
      dailyVolume: '₹1,250 Cr',
      minuteVolume: '16,400 Shares',
      evalSpeedSec: 7,
      strategyType: 'Asymmetric Event Option Straddle',
      mathFormula: String.raw`V_t = e^{-\lambda \tau} \sum_{j=0}^{\infty} \frac{(\lambda \tau)^j}{j!} \text{BSM}(S_0 e^{j \mu_J}, K, \sigma_j, r, \tau)`,
      tier: 'A-TIER',
      sentimentSource: 'USFDA Inspection Form 483 / EIR Approvals & Clinical Pipeline',
      sentimentScore: +0.62,
      sentimentRegime: 'DIVINE_HEALING_EXPANSION',
      sentimentSignal: 'Clean EIR audit clearance (+0.62); positioning asymmetric gamma straddles ahead of major regulatory ANDA approvals.',
      allocatedCapINR: 850000,
      baseDailyAlphaINR: 1350,
      realizedPnlINR: 21600,
      winRate: 73.0,
      tradesToday: 12,
      sharpe: 2.48,
      profitFactor: 2.30,
      maxDD: -0.78,
      laymanExplanation: 'Captures asymmetric windfall gains when pharma companies receive major USFDA drug clearances or clinical trials report breakthroughs.',
      mathDerivation: String.raw`dS_t = \mu S_t dt + \sigma S_t dW_t + S_t (e^J - 1) dN_t`,
      entryRules: 'Enter long gamma straddle 7 trading days prior to expected regulatory action date.',
      exitRules: 'Close position within 30 minutes of regulatory disclosure to lock in IV expansion or underlying move.',
      crisisReplay: 'Immune to economic recessions; generated +22.4% during 2020 pandemic onset.'
    },
    {
      id: 'BOT-EG-IN-07',
      market: 'india',
      ...
      mythName: 'OSIRIS',
      mythIcon: '🌾',
      mythTitle: 'Lord of Rebirth & Earth\'s Mineral Riches',
      primarySymbol: 'TATASTEEL.NS',
      displayAsset: 'TATASTEEL / JSWSTEEL / HINDALCO',
      venue: 'NSE COLOCATION',
      basePrice: 154.2,
      currentPrice: 154.2,
      dailyVolume: '₹2,100 Cr',
      minuteVolume: '48,000 Shares',
      evalSpeedSec: 6,
      strategyType: 'Commodity Cycle Mean Reversion',
      mathFormula: String.raw`dx_t = \kappa(\theta - x_t) dt + \sigma_x dW_t \quad (\text{Half-Life} = \frac{\ln 2}{\kappa})`,
      tier: 'A-TIER',
      sentimentSource: 'London Metal Exchange (LME) Inventories & Chinese PMI Data',
      sentimentScore: +0.28,
      sentimentRegime: 'MINERAL_REBIRTH',
      sentimentSignal: 'LME warehouse copper & steel inventory drawdown (+0.28); buying cyclical oversold dips on multi-week support.',
      allocatedCapINR: 950000,
      baseDailyAlphaINR: 1620,
      realizedPnlINR: 27200,
      winRate: 67.5,
      tradesToday: 18,
      sharpe: 2.24,
      profitFactor: 2.15,
      maxDD: -1.20,
      laymanExplanation: 'Like Osiris rising from the earth, metals experience predictable cyclical death and rebirth. Buys oversold metal stocks when global inventories dry up.',
      mathDerivation: String.raw`x_t = \ln(P_{\text{metal}}) - \ln(P_{\text{commodity}}), \quad \mathbb{E}[x_t | x_0] = \theta + (x_0 - \theta) e^{-\kappa t}`,
      entryRules: 'Enter long when Ornstein-Uhlenbeck z-score z < -2.0 and RSI(14) < 32.',
      exitRules: 'Exit when z-score converges to zero or trailing 2.0 ATR stop.',
      crisisReplay: 'Disciplined Ornstein-Uhlenbeck scaling avoided false bottoms in the 2015 commodity glut.'
    },
    {
      id: 'BOT-EG-IN-08',
      market: 'india',
      ...
      mythName: 'BASTET',
      mythIcon: '🐱',
      mythTitle: 'Goddess of Agility, Protection & Defensive Alpha',
      primarySymbol: 'ITC.NS',
      displayAsset: 'ITC / HINDUNILVR / NESTLEIND',
      venue: 'NSE PRISM',
      basePrice: 492.0,
      currentPrice: 492.0,
      dailyVolume: '₹1,450 Cr',
      minuteVolume: '24,000 Shares',
      evalSpeedSec: 8,
      strategyType: 'Auction Value Area Mean Reversion',
      mathFormula: String.raw`\text{POC} = \arg\max_P V(P), \quad \text{VA} = \{P : \int_{P_{\text{low}}}^{P_{\text{high}}} V(P) dP = 0.70 V_{\text{total}}\}`,
      tier: 'S-TIER',
      sentimentSource: 'Rural Monsoon Rainfall Index & FMCG Volume Growth',
      sentimentScore: +0.42,
      sentimentRegime: 'AGILE_DEFENSIVE_ALPHA',
      sentimentSignal: 'Consumer staples demand steady (+0.42); fading deviations outside the 70% Value Area back toward Point of Control (POC).',
      allocatedCapINR: 950000,
      baseDailyAlphaINR: 1480,
      realizedPnlINR: 19800,
      winRate: 78.0,
      tradesToday: 16,
      sharpe: 3.08,
      profitFactor: 2.85,
      maxDD: -0.48,
      laymanExplanation: 'Guards the portfolio with feline agility. When defensive FMCG stocks trade outside their institutional fair value zone, buys the dip and sells the spike.',
      mathDerivation: String.raw`\text{Spread} = \text{VAH} - \text{VAL}, \quad \text{Edge} = |P_t - \text{POC}| > 1.25 \cdot \text{StdDev}(V)`,
      entryRules: 'Buy when price touches Value Area Low (VAL) with declining tick volume.',
      exitRules: 'Take profit when price returns to Point of Control (POC).',
      crisisReplay: 'Maximum drawdown of only -3.2% throughout the 2020 COVID selloff.'
    },
    {
      id: 'BOT-EG-IN-09',
      market: 'india',
      ...
      mythName: 'HORUS',
      mythIcon: '🦅',
      mythTitle: 'All-Seeing Falcon Eye of Level-2 Order Flow Imbalance',
      primarySymbol: 'HAL.NS',
      displayAsset: 'HAL / BEL / LT',
      venue: 'NSE COLOCATION',
      basePrice: 4850.0,
      currentPrice: 4850.0,
      dailyVolume: '₹2,600 Cr',
      minuteVolume: '18,500 Shares',
      evalSpeedSec: 2,
      strategyType: 'High-Frequency Passive Market Quoting',
      mathFormula: String.raw`r(s, q, t) = s - q \gamma \sigma^2 (T - t), \quad \delta^a + \delta^b = \gamma \sigma^2 (T - t) + \frac{2}{\gamma} \ln\left(1 + \frac{\gamma}{\kappa}\right)`,
      tier: 'S-TIER',
      sentimentSource: 'Defense Ministry Acquisition Council (DAC) Contract Orders',
      sentimentScore: +0.82,
      sentimentRegime: 'FALCON_EYE_OFI',
      sentimentSignal: 'Order book bid depth thickening (+0.82); quoting inside touch spread with zero inventory buildup risk.',
      allocatedCapINR: 1200000,
      baseDailyAlphaINR: 2350,
      realizedPnlINR: 39400,
      winRate: 85.2,
      tradesToday: 54,
      sharpe: 3.95,
      profitFactor: 3.80,
      maxDD: -0.32,
      laymanExplanation: 'Watches the order book like a falcon scanning the sands. Quotes bids and asks at microsecond speeds, earning the spread on institutional orders.',
      mathDerivation: String.raw`\text{OFI}_k = \Delta Q_{\text{bid}} - \Delta Q_{\text{ask}}, \quad \Delta P = \lambda \cdot \text{OFI}_k + \epsilon`,
      entryRules: 'Post limit orders inside bid-ask touch when spread ≥ 14 bps and Kyle\'s lambda > 1.8.',
      exitRules: 'Cancel quote if unfilled after 350ms or on adverse inventory accumulation.',
      crisisReplay: 'Zero overnight risk; 100% cash balance maintained at 15:30 IST close.'
    },
    {
      id: 'BOT-EG-IN-10',
      market: 'india',
      ...
      mythName: 'HATHOR',
      mythIcon: '👑',
      mythTitle: 'Golden Goddess of Abundance, Wealth & Sovereign Bullion',
      primarySymbol: 'GOLDBEES.NS',
      displayAsset: 'MCX GOLD / SILVER / GOLDBEES',
      venue: 'MCX / NSE PRISM',
      basePrice: 78420.0,
      currentPrice: 78420.0,
      dailyVolume: '₹4,100 Cr',
      minuteVolume: '32,000 Lots',
      evalSpeedSec: 8,
      strategyType: 'Sovereign Bullion Macro Currency Hedge',
      mathFormula: String.raw`\text{Gold}_{\text{INR}} = \text{Gold}_{\text{USD}} \cdot \left(\frac{\text{USD}}{\text{INR}}\right) \cdot (1 + \text{ImportDuty})`,
      tier: 'S-TIER',
      sentimentSource: 'US Real 10Y TIPS Yield & RBI Foreign Exchange Reserve Growth',
      sentimentScore: +0.68,
      sentimentRegime: 'GOLDEN_ABUNDANCE',
      sentimentSignal: 'Global central bank bullion accumulation strong (+0.68); trend following sovereign gold hedge against currency debasement.',
      allocatedCapINR: 1450000,
      baseDailyAlphaINR: 2050,
      realizedPnlINR: 51400,
      winRate: 71.0,
      tradesToday: 18,
      sharpe: 2.82,
      profitFactor: 2.65,
      maxDD: -0.85,
      laymanExplanation: 'Harnesses the eternal wealth of gold. Rises automatically whenever sovereign currencies face inflation or central banks expand their reserves.',
      mathDerivation: String.raw`\frac{dP_{\text{gold}}}{P_{\text{gold}}} = -\beta_{r} d(r_{\text{real}}) + \beta_{\text{fx}} d(\ln \text{USDINR}) + \sigma dW`,
      entryRules: 'Enter long gold momentum when US 10Y real yields roll over and 50-day EMA > 200-day EMA.',
      exitRules: 'Trailing stop at 3.0 ATR or yield breakout above +2.50%.',
      crisisReplay: 'Delivered +28.5% total return during 2022-2024 global stagflation cycle.'
    },
    ...
    // ══════════════════════════════════════════════════════════════════════════
    {
      ...
      mythName: 'AMUN-RA',
      mythIcon: '☀️',
      mythTitle: 'The Hidden Supreme Creator of Silicon AI Dominance',
      primarySymbol: 'NVDA',
      displayAsset: 'NVDA / AAPL / MSFT',
      venue: 'NASDAQ DIRECT FIX',
      basePrice: 128.50,
      currentPrice: 128.50,
      dailyVolume: '$52.4 Billion',
      minuteVolume: '380,000 Shares',
      evalSpeedSec: 3,
      strategyType: 'Almgren-Chriss Dark Slicing',
      mathFormula: String.raw`x_j = \frac{\sinh(\kappa (T - t_j))}{\sinh(\kappa T)} X_0, \quad \kappa \approx \sqrt{\frac{\lambda \sigma^2}{\eta}}`,
      tier: 'S-TIER',
      sentimentSource: 'Hyperscaler GPU Clustering Demand & Cloud Backlog',
      sentimentScore: +0.85,
      sentimentRegime: 'HIDDEN_SUPREME_AI',
      sentimentSignal: 'Massive institutional block buying detected in dark pools (+0.85); slicing VWAP liquidation schedules with minimal price impact.',
      allocatedCapINR: 1900000,
      baseDailyAlphaINR: 3100,
      realizedPnlINR: 62500,
      winRate: 81.0,
      tradesToday: 48,
      sharpe: 3.38,
      profitFactor: 3.10,
      maxDD: -0.52,
      laymanExplanation: 'The hidden power behind mega-cap tech. Executes massive multi-million dollar orders across dark venues without tipping off the rest of the market.',
      mathDerivation: String.raw`\min_{\{v_j\}} \mathbb{E}[x] + \lambda \mathbb{V}[x], \quad \text{where } \text{Impact}(v) = \gamma v^2`,
      entryRules: 'Activate optimal execution when institutional parent order size exceeds 2% of 20-day ADV.',
      exitRules: 'Complete schedule at end of VWAP horizon with zero lingering market inventory.',
      crisisReplay: 'Reduced market impact slippage by 18.5 bps during high-volume index rebalancing.'
    },
    {
      id: 'BOT-EG-US-02',
      market: 'us',
      ...
      mythName: 'PTAH',
      mythIcon: '🏛️',
      mythTitle: 'Divine Master Craftsman & Architect of Capital Goods',
      primarySymbol: 'GE',
      displayAsset: 'GE / CAT / BA',
      venue: 'NYSE FIX DIRECT',
      basePrice: 182.40,
      currentPrice: 182.40,
      dailyVolume: '$8.4 Billion',
      minuteVolume: '54,000 Shares',
      evalSpeedSec: 5,
      strategyType: 'Kyle-Lambda Microstructure Impact',
      mathFormula: String.raw`\Delta P_t = \lambda (V_t^b - V_t^a) + \eta_t, \quad \lambda = \frac{2 \sigma_v}{\sigma_u}`,
      tier: 'A-TIER',
      sentimentSource: 'Commercial Aircraft Backlog & Heavy Equipment Capex',
      sentimentScore: +0.48,
      sentimentRegime: 'DIVINE_CRAFTSMAN_VALUE',
      sentimentSignal: 'Heavy machinery order flow positive (+0.48); buying high-order backlog industrials with steady cash flows.',
      allocatedCapINR: 1050000,
      baseDailyAlphaINR: 1680,
      realizedPnlINR: 25400,
      winRate: 68.5,
      tradesToday: 20,
      sharpe: 2.36,
      profitFactor: 2.20,
      maxDD: -0.98,
      laymanExplanation: 'Builds wealth on solid foundations like Ptah crafting monuments. Detects informed order flow in industrial giants and rides structural multi-month expansions.',
      mathDerivation: String.raw`\text{Impact} = \lambda \cdot \text{OFI}, \quad \text{where } \text{OFI} = \sum (I_{\text{buy}} - I_{\text{sell}})`,
      entryRules: 'Enter long when Kyle\'s lambda exceeds 1.5 and order backlog growth > 8% YoY.',
      exitRules: 'Close on negative order flow reversal or 20-day SMA breakdown.',
      crisisReplay: 'Outperformed S&P 500 by +9.2% during 2022 manufacturing supply shocks.'
    },
    {
      id: 'BOT-EG-US-03',
      market: 'us',
      ...
      mythName: 'ANUBIS',
      mythIcon: '🐺',
      mythTitle: 'Guardian of Sovereign Treasuries & Duration Matching',
      primarySymbol: 'JPM',
      displayAsset: 'JPM / GS / TLT',
      venue: 'NYSE COLOCATION',
      basePrice: 218.60,
      currentPrice: 218.60,
      dailyVolume: '$14.2 Billion',
      minuteVolume: '78,000 Shares',
      evalSpeedSec: 6,
      strategyType: 'Nelson-Siegel Yield Curve Steepener',
      mathFormula: String.raw`y(m) = \beta_0 + \beta_1 \left(\frac{1 - e^{-m/\tau}}{m/\tau}\right) + \beta_2 \left(\frac{1 - e^{-m/\tau}}{m/\tau} - e^{-m/\tau}\right)`,
      tier: 'S-TIER',
      sentimentSource: 'Federal Reserve Dot Plot & Net Interest Margin (NIM) Guidance',
      sentimentScore: +0.58,
      sentimentRegime: 'STEEPENING_TREASURY_SCALES',
      sentimentSignal: 'Yield curve un-inversion accelerating (+0.58); long money-center banks while matching duration against Treasury futures.',
      allocatedCapINR: 1300000,
      baseDailyAlphaINR: 2100,
      realizedPnlINR: 36800,
      winRate: 77.5,
      tradesToday: 24,
      sharpe: 3.05,
      profitFactor: 2.90,
      maxDD: -0.42,
      laymanExplanation: 'Weighs the shape of the US bond yield curve. Profits when interest rate expectations normalize and commercial banks expand their lending margins.',
      mathDerivation: String.raw`\text{DV01}_{\text{Portfolio}} = \sum w_i \text{DV01}_i = 0 \quad (\text{Duration Neutral})`,
      entryRules: 'Enter curve steepener when 2s10s spread expands by > 12 bps over 5 sessions.',
      exitRules: 'Take profit on target curve slope or re-hedge upon 10Y yield reversal.',
      crisisReplay: 'Delivered +16.2% return during the 2023 Silicon Valley Bank liquidity flight.'
    },
    {
      id: 'BOT-EG-US-04',
      market: 'us',
      ...
      mythName: 'ISIS',
      mythIcon: '🌿',
      mythTitle: 'Divine Healer of Biopharma Asymmetry',
      primarySymbol: 'LLY',
      displayAsset: 'LLY / NVO / UNH',
      venue: 'NYSE FIX',
      basePrice: 945.00,
      currentPrice: 945.00,
      dailyVolume: '$11.8 Billion',
      minuteVolume: '42,000 Shares',
      evalSpeedSec: 5,
      strategyType: 'Merton Jump-Diffusion Option Pricing',
      mathFormula: String.raw`dS_t = (r - \lambda k) S_t dt + \sigma S_t dW_t + S_t (e^J - 1) dN_t`,
      tier: 'S-TIER',
      sentimentSource: 'FDA PDUFA Priority Reviews & GLP-1 Weight Loss Prescriptions',
      sentimentScore: +0.76,
      sentimentRegime: 'REGENERATIVE_BIOTECH_JUMP',
      sentimentSignal: 'Weight-loss prescription velocity compounding (+0.76); monetizing gamma on explosive clinical label expansion.',
      allocatedCapINR: 1350000,
      baseDailyAlphaINR: 2280,
      realizedPnlINR: 39800,
      winRate: 75.5,
      tradesToday: 18,
      sharpe: 2.85,
      profitFactor: 2.70,
      maxDD: -0.75,
      laymanExplanation: 'Harnesses medical breakthroughs with jump-diffusion math. Prices options accurately around binary FDA decision dates to capture asymmetric moves.',
      mathDerivation: String.raw`\ln(1 + J) \sim \mathcal{N}(\gamma, \delta^2), \quad k = \mathbb{E}[e^J - 1] = e^{\gamma + \delta^2 / 2} - 1`,
      entryRules: 'Enter long straddle when implied jump probability is underpriced by > 25% vs historical distribution.',
      exitRules: 'Close immediately post-announcement to eliminate post-event implied volatility crush.',
      crisisReplay: 'Zero correlation to macro cycles; gained +34.8% during major GLP-1 trial readouts.'
    },
    {
      id: 'BOT-EG-US-05',
      market: 'us',
      ...
      mythName: 'SOBEK',
      mythIcon: '🌊',
      mythTitle: 'Master of the Crude Delta & Permian Rigs',
      primarySymbol: 'XOM',
      displayAsset: 'XOM / CVX / COP',
      venue: 'NYSE FIX',
      basePrice: 118.50,
      currentPrice: 118.50,
      dailyVolume: '$9.2 Billion',
      minuteVolume: '62,000 Shares',
      evalSpeedSec: 7,
      strategyType: 'Fama-French 5-Factor Commodity Alpha',
      mathFormula: String.raw`R_i - R_f = \alpha_i + \beta_1 \text{MKT} + \beta_2 \text{SMB} + \beta_3 \text{HML} + \beta_4 \text{RMW} + \beta_5 \text{CMA} + \gamma \text{Crack}`,
      tier: 'A-TIER',
      sentimentSource: 'Permian Basin Wellhead Depletion & OPEC+ Spare Capacity',
      sentimentScore: +0.44,
      sentimentRegime: 'PERMIAN_CRACK_DISLOCATION',
      sentimentSignal: 'Refining 3-2-1 crack spreads firming (+0.44); capturing relative cash flow yields while shorting high-debt exploration peers.',
      allocatedCapINR: 1150000,
      baseDailyAlphaINR: 1750,
      realizedPnlINR: 28500,
      winRate: 71.0,
      tradesToday: 16,
      sharpe: 2.52,
      profitFactor: 2.40,
      maxDD: -0.70,
      laymanExplanation: 'Tracks the physical cash flow of oil refineries. Buys energy supermajors when refining margins expand faster than crude feedstock costs.',
      mathDerivation: String.raw`\text{Crack}_{3:2:1} = \frac{2 P_{\text{gasoline}} + 1 P_{\text{distillate}} - 3 P_{\text{crude}}}{3}`,
      entryRules: 'Enter long energy factor basket when 3-2-1 crack spread exceeds 50-day moving average by 1.5σ.',
      exitRules: 'Exit on mean-reversion of crack spread or trailing 2.2 ATR stop.',
      crisisReplay: 'Protected portfolio returns during 2022 geopolitical energy shortages.'
    },
    {
      id: 'BOT-EG-US-06',
      market: 'us',
      ...
      mythName: 'HORUS',
      mythIcon: '⚡',
      mythTitle: 'Piercing Gaze Across Nanometer Supply Chains',
      primarySymbol: 'AMD',
      displayAsset: 'AMD / TSM / AVGO',
      venue: 'NASDAQ DIRECT FIX',
      basePrice: 156.40,
      currentPrice: 156.40,
      dailyVolume: '$24.6 Billion',
      minuteVolume: '145,000 Shares',
      evalSpeedSec: 3,
      strategyType: 'Dynamic Gamma Volatility Scalping',
      mathFormula: String.raw`\Delta_{\text{net}} = \sum_{i} N_i \Delta_i + N_{\text{shares}} = 0, \quad \text{P\&L}_{\Gamma} \approx \frac{1}{2} \Gamma (\Delta S)^2 - \Theta \Delta t`,
      tier: 'S-TIER',
      sentimentSource: 'TSMC Wafer Fab Lead Times & Advanced Packaging (CoWoS) Capacity',
      sentimentScore: +0.74,
      sentimentRegime: 'NANOMETER_SUPPLY_SQUEEZE',
      sentimentSignal: 'Foundry packaging lead times extended (+0.74); buying long options gamma and delta-hedging dynamically on intraday swings.',
      allocatedCapINR: 1600000,
      baseDailyAlphaINR: 2850,
      realizedPnlINR: 52400,
      winRate: 74.5,
      tradesToday: 38,
      sharpe: 2.95,
      profitFactor: 2.80,
      maxDD: -0.88,
      laymanExplanation: 'Keeps a falcon eye on semiconductor bottlenecks. Uses option gamma to profit from large intraday swings in chip stocks while hedging away directional risk.',
      mathDerivation: String.raw`\Gamma = \frac{\partial^2 V}{\partial S^2} = \frac{\phi(d_1)}{S \sigma \sqrt{T}}, \quad \text{Rehedge on } |\Delta_{\text{net}}| > 0.08`,
      entryRules: 'Enter long straddle when Implied Volatility sits below 20-day realized volatility.',
      exitRules: 'Rebalance delta back to zero every 15 minutes and exit 1 day prior to expiration.',
      crisisReplay: 'Monetized heavy swings during US export control policy updates.'
    },
    {
      id: 'BOT-EG-US-07',
      market: 'us',
      ...
      mythName: 'KHONSU',
      mythIcon: '🌙',
      mythTitle: 'Traveler of the Night Sky & Continuous Perpetual Basis',
      primarySymbol: 'BTC-USD',
      displayAsset: 'BTC-USD / ETH-USD / SOL-USD',
      venue: 'CME / BINANCE FIX',
      basePrice: 64280.0,
      currentPrice: 64280.0,
      dailyVolume: '$38.5 Billion',
      minuteVolume: '1,420 BTC',
      evalSpeedSec: 2,
      strategyType: 'Delta-Neutral Perpetual Funding Carry',
      mathFormula: String.raw`\text{Yield}_{\text{APR}} = \left(\sum_{k=1}^3 F_k\right) \cdot 365 \cdot 100\% \quad (\text{where } F_k > +0.01\%)`,
      tier: 'S-TIER',
      sentimentSource: 'Derivatives Open Interest & Perpetual Swap Funding Rate',
      sentimentScore: +0.88,
      sentimentRegime: 'NIGHT_SKY_PERPETUAL_CARRY',
      sentimentSignal: 'Perpetual swap funding rate positive (+0.025% / 8h); long spot crypto and short perpetual futures to earn +27.4% APR risk-free.',
      allocatedCapINR: 2100000,
      baseDailyAlphaINR: 3650,
      realizedPnlINR: 79500,
      winRate: 98.5,
      tradesToday: 64,
      sharpe: 5.55,
      profitFactor: 6.20,
      maxDD: -0.12,
      laymanExplanation: 'Travels the 24/7 crypto markets while you sleep. Buys spot Bitcoin and shorts perpetual futures to harvest funding fees paid by leveraged retail traders.',
      mathDerivation: String.raw`\text{Daily Return} = 3 \cdot \text{FundingRate} - \text{BorrowCost}, \quad \beta_{\text{market}} = 0.00`,
      entryRules: 'Enter when perpetual funding rate exceeds +0.015% per 8-hour epoch (> +16.4% APR).',
      exitRules: 'Close position if funding rate drops below 0.00% or goes negative.',
      crisisReplay: 'Maintained 100% positive carry throughout the 2022 FTX and Terra Luna insolvencies.'
    },
    {
      id: 'BOT-EG-US-08',
      market: 'us',
      ...
      mythName: 'SET',
      mythIcon: '🌪️',
      mythTitle: 'God of Desert Storms, Chaos & Extreme Volatility Spikes',
      primarySymbol: 'SPY',
      displayAsset: 'SPY OTM Puts / VXX / UVXY',
      venue: 'CBOE / AMEX FIX',
      basePrice: 564.80,
      currentPrice: 564.80,
      dailyVolume: '$62.0 Billion',
      minuteVolume: '420,000 Contracts',
      evalSpeedSec: 4,
      strategyType: 'EVT Tail Risk Convexity Sizing',
      mathFormula: String.raw`G_{\xi, \sigma}(y) = 1 - \left(1 + \frac{\xi y}{\sigma}\right)^{-1/\xi}, \quad \mathbb{E}[L | L > u] = \frac{u + \sigma - \xi u}{1 - \xi}`,
      tier: 'A-TIER',
      sentimentSource: 'CBOE SKEW Index, Term Structure Inversion & Credit Spreads',
      sentimentScore: -0.65,
      sentimentRegime: 'DESERT_STORM_CHAOS',
      sentimentSignal: 'VIX term structure flattening; allocating 1.2% capital to deep OTM puts (20Δ) with 10x-50x payoff potential during sudden crash.',
      allocatedCapINR: 1000000,
      baseDailyAlphaINR: 1850,
      realizedPnlINR: 34800,
      winRate: 64.0,
      tradesToday: 14,
      sharpe: 2.18,
      profitFactor: 2.35,
      maxDD: -1.40,
      laymanExplanation: 'Feeds on sudden market panics and desert storms. Invests tiny fractions in catastrophic crash insurance that explodes 10x-50x in value when markets plummet.',
      mathDerivation: String.raw`\text{Budget} = \min\left(0.015 \cdot \text{Portfolio}, \frac{\text{Alpha}}{4}\right), \quad K = 0.85 \cdot S_0`,
      entryRules: 'Buy OTM tail puts when CBOE SKEW index exceeds 145 or credit spreads widen by 30 bps.',
      exitRules: 'Monetize immediately when VIX spikes above 35 or stop loss on premium expiry.',
      crisisReplay: 'Generated +820% ROI on premium during the March 2020 COVID flash crash.'
    },
    {
      id: 'BOT-EG-US-09',
      market: 'us',
      ...
      mythName: 'BASTET',
      mythIcon: '🐾',
      mythTitle: 'Agile Stalker of Consumer Velocity & Foot Traffic',
      primarySymbol: 'AMZN',
      displayAsset: 'AMZN / TSLA / HD / COST',
      venue: 'NASDAQ FIX DIRECT',
      basePrice: 186.20,
      currentPrice: 186.20,
      dailyVolume: '$18.5 Billion',
      minuteVolume: '110,000 Shares',
      evalSpeedSec: 4,
      strategyType: 'Dual Momentum Relative Alpha',
      mathFormula: String.raw`\text{Score}_i = 0.5 R_i(21) + 0.3 R_i(63) + 0.2 R_i(126) \quad \text{s.t. } R_i(126) > R_f`,
      tier: 'S-TIER',
      sentimentSource: 'Credit Card Spending Data & E-Commerce Web Foot Traffic',
      sentimentScore: +0.68,
      sentimentRegime: 'AGILE_RETAIL_VELOCITY',
      sentimentSignal: 'Consumer discretionary velocity leading broad market (+0.68); rotating capital into top-performing retail titans.',
      allocatedCapINR: 1250000,
      baseDailyAlphaINR: 2350,
      realizedPnlINR: 44500,
      winRate: 92.5,
      tradesToday: 28,
      sharpe: 4.92,
      profitFactor: 5.40,
      maxDD: -0.25,
      laymanExplanation: 'Stalks retail stocks with supreme agility. Compares consumer stocks against each other and only buys the absolute fastest runners while holding cash if the sector weakens.',
      mathDerivation: String.raw`w_i^* = \frac{1}{K} \mathbb{I}\left(\text{Rank}(\text{Score}_i) \le K \land \text{Score}_i > 0\right)`,
      entryRules: 'Enter top 2 ranked retail equities with positive 126-day excess return over T-bills.',
      exitRules: 'Rebalance monthly or switch to short-term Treasuries if sector momentum turns negative.',
      crisisReplay: 'Automatically pivoted 100% into cash during the 2022 consumer retail downturn.'
    },
    {
      id: 'BOT-EG-US-10',
      market: 'us',
      ...
      mythName: 'THOTH',
      mythIcon: '📐',
      mythTitle: 'Architect of Probability, Entropy & Bayesian Inference',
      primarySymbol: 'PREDICT-LMSR',
      displayAsset: 'FED_FUNDS / CPI / MACRO_EVENT_PROBS',
      venue: 'POLYMARKET / KALSHI API',
      basePrice: 100.00,
      currentPrice: 100.00,
      dailyVolume: '$4.2 Million',
      minuteVolume: '18,500 Shares',
      evalSpeedSec: 5,
      strategyType: 'Bayesian Half-Kelly Event Sizing',
      mathFormula: String.raw`f^* = \frac{1}{2} \left(\frac{p(b + 1) - 1}{b}\right) = \frac{1}{2} \left(\frac{P_{\text{Bayes}} - P_{\text{market}}}{1 - P_{\text{market}}}\right)`,
      tier: 'S-TIER',
      sentimentSource: 'Real-Time Inflation Nowcasts & FOMC Speech NLP Embeddings',
      sentimentScore: +0.72,
      sentimentRegime: 'ARCHITECT_OF_PROBABILITY',
      sentimentSignal: 'Macro economic nowcast diverges from prediction market pricing (+0.72); sizing positions using fractional Half-Kelly formula.',
      allocatedCapINR: 950000,
      baseDailyAlphaINR: 1920,
      realizedPnlINR: 33400,
      winRate: 84.0,
      tradesToday: 32,
      sharpe: 3.65,
      profitFactor: 3.45,
      maxDD: -0.40,
      laymanExplanation: 'Applies sacred probability mathematics to prediction markets. Bets with optimal Half-Kelly sizing whenever crowd emotions misprice economic outcomes.',
      mathDerivation: String.raw`P(A | B) = \frac{P(B | A) P(A)}{P(B)}, \quad \text{Entropy} = -\sum p_i \ln p_i`,
      entryRules: 'Buy binary outcome contracts when model probability exceeds market price by > 7.5%.',
      exitRules: 'Hold to contract expiry ($1.00 payout) or exit when market probability matches fair value.',
      crisisReplay: 'Achieved 86% win rate predicting Federal Reserve interest rate pause announcements.'
    }
