# Mathematical Lemma: Gatheral Non-Linear Market Impact with Power-Law Decay Kernels

**Category**: Market Microstructure & Order Flow  
**Classification**: Formal Quantitative Specification & Mathematical Invariant  
**Engine Ref**: `packages/quant-core/microstructure/gatheral_decay_impact.py`
...
The fundamental relationship for **Gatheral Non-Linear Market Impact with Power-Law Decay Kernels** is governed by the operator:
