# Mathematical Lemma: Cont-Kukanov-Stoikov Level-2 Order Flow Price Dynamics

**Category**: Market Microstructure & Order Flow  
**Classification**: Formal Quantitative Specification & Mathematical Invariant  
**Engine Ref**: `packages/quant-core/microstructure/order_flow_imbalance_pde.py`
...
The fundamental relationship for **Cont-Kukanov-Stoikov Level-2 Order Flow Price Dynamics** is governed by the operator:
