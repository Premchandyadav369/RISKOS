# Mathematical Lemma: Kyle's Continuous Auction Bayesian Nash Equilibrium

**Category**: Market Microstructure & Order Flow  
**Classification**: Formal Quantitative Specification & Mathematical Invariant  
**Engine Ref**: `packages/quant-core/microstructure/kyle_lambda_equilibrium.py`
...
The fundamental relationship for **Kyle's Continuous Auction Bayesian Nash Equilibrium** is governed by the operator:
