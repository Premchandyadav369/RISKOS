# Mathematical Lemma: Glosten-Milgrom Sequential Information Spread Decomposition

**Category**: Market Microstructure & Order Flow  
**Classification**: Formal Quantitative Specification & Mathematical Invariant  
**Engine Ref**: `packages/quant-core/microstructure/glosten_milgrom_spread.py`
...
The fundamental relationship for **Glosten-Milgrom Sequential Information Spread Decomposition** is governed by the operator:
