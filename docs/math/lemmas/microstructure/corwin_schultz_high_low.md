# Mathematical Lemma: Corwin-Schultz Bid-Ask Spread Estimation from High-Low Prices

**Category**: Market Microstructure & Order Flow  
**Classification**: Formal Quantitative Specification & Mathematical Invariant  
**Engine Ref**: `packages/quant-core/microstructure/corwin_schultz_high_low.py`
...
The fundamental relationship for **Corwin-Schultz Bid-Ask Spread Estimation from High-Low Prices** is governed by the operator:
