# Mathematical Lemma: Bulk Volume Classification (BVC) Limit in High-Frequency Order Flow

**Category**: Market Microstructure & Order Flow  
**Classification**: Formal Quantitative Specification & Mathematical Invariant  
**Engine Ref**: `packages/quant-core/microstructure/vpin_bvc_convergence.py`
...
The fundamental relationship for **Bulk Volume Classification (BVC) Limit in High-Frequency Order Flow** is governed by the operator:
