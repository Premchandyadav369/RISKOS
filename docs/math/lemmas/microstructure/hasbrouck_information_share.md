# Mathematical Lemma: Hasbrouck Cointegrated Price Discovery Information Shares

**Category**: Market Microstructure & Order Flow  
**Classification**: Formal Quantitative Specification & Mathematical Invariant  
**Engine Ref**: `packages/quant-core/microstructure/hasbrouck_information_share.py`
...
The fundamental relationship for **Hasbrouck Cointegrated Price Discovery Information Shares** is governed by the operator:
