# Mathematical Lemma: Roll Model Serial Covariance Estimator of Effective Spread

**Category**: Market Microstructure & Order Flow  
**Classification**: Formal Quantitative Specification & Mathematical Invariant  
**Engine Ref**: `packages/quant-core/microstructure/roll_effective_spread.py`
...
The fundamental relationship for **Roll Model Serial Covariance Estimator of Effective Spread** is governed by the operator:
