# Mathematical Lemma: Amihud Return-to-Volume Ratio Asymptotic Distribution

**Category**: Market Microstructure & Order Flow  
**Classification**: Formal Quantitative Specification & Mathematical Invariant  
**Engine Ref**: `packages/quant-core/microstructure/amihud_illiquidity_ratio.py`
...
The fundamental relationship for **Amihud Return-to-Volume Ratio Asymptotic Distribution** is governed by the operator:
