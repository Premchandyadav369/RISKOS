# Mathematical Lemma: Barone-Adesi-Whaley American Option Quadratic Approximation

**Category**: Option Pricing & Volatility Dynamics  
**Classification**: Formal Quantitative Specification & Mathematical Invariant  
**Engine Ref**: `packages/quant-core/derivatives/barone_adesi_whaley.py`
...
The fundamental relationship for **Barone-Adesi-Whaley American Option Quadratic Approximation** is governed by the operator:
