# Mathematical Lemma: Dupire's Local Volatility Formula from Vanilla Surface

**Category**: Option Pricing & Volatility Dynamics  
**Classification**: Formal Quantitative Specification & Mathematical Invariant  
**Engine Ref**: `packages/quant-core/derivatives/dupire_local_vol.py`
...
The fundamental relationship for **Dupire's Local Volatility Formula from Vanilla Surface** is governed by the operator:
