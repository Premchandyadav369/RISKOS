# Mathematical Lemma: Margrabe Formula for Exchange Options between Two Assets

**Category**: Option Pricing & Volatility Dynamics  
**Classification**: Formal Quantitative Specification & Mathematical Invariant  
**Engine Ref**: `packages/quant-core/derivatives/margrabe_spread_formula.py`
...
The fundamental relationship for **Margrabe Formula for Exchange Options between Two Assets** is governed by the operator:
