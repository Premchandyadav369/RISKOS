# Mathematical Lemma: Gatheral SVI Parameter Bounds for Butterfly No-Arbitrage

**Category**: Option Pricing & Volatility Dynamics  
**Classification**: Formal Quantitative Specification & Mathematical Invariant  
**Engine Ref**: `packages/quant-core/derivatives/svi_no_arbitrage.py`
...
The fundamental relationship for **Gatheral SVI Parameter Bounds for Butterfly No-Arbitrage** is governed by the operator:
