# Mathematical Lemma: Bachelier Normal Implied Volatility and Displaced Diffusion

**Category**: Option Pricing & Volatility Dynamics  
**Classification**: Formal Quantitative Specification & Mathematical Invariant  
**Engine Ref**: `packages/quant-core/derivatives/bachelier_normal_greeks.py`
...
The fundamental relationship for **Bachelier Normal Implied Volatility and Displaced Diffusion** is governed by the operator:
