# Mathematical Lemma: Christoffersen Markov Chain Independence Likelihood Ratio
...
**Engine Ref**: `packages/quant-core/risk/christoffersen_independence.py`
...
The fundamental relationship for **Christoffersen Markov Chain Independence Likelihood Ratio** is governed by the operator:
