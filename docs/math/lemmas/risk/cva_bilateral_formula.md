# Mathematical Lemma: Bilateral Credit Valuation Adjustment (CVA/DVA) Formulation
...
**Engine Ref**: `packages/quant-core/risk/cva_bilateral_formula.py`
...
The fundamental relationship for **Bilateral Credit Valuation Adjustment (CVA/DVA) Formulation** is governed by the operator:
