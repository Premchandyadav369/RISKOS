# Mathematical Lemma: Subadditivity Proof of Expected Shortfall as Coherent Risk Measure

**Category**: Tail Risk, Extreme Values & Capital Requirements  
**Classification**: Formal Quantitative Specification & Mathematical Invariant  
**Engine Ref**: `packages/quant-core/risk/expected_shortfall_subadditivity.py`
...
The fundamental relationship for **Subadditivity Proof of Expected Shortfall as Coherent Risk Measure** is governed by the operator:
