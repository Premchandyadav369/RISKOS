# Mathematical Lemma: Spectral Risk Measures and Distortion Weighting Functions
...
**Engine Ref**: `packages/quant-core/risk/spectral_risk_measures.py`
...
The fundamental relationship for **Spectral Risk Measures and Distortion Weighting Functions** is governed by the operator:
