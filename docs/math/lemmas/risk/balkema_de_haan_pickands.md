# Mathematical Lemma: Balkema-de Haan-Pickands Theorem for POT GPD Exceedances
...
**Engine Ref**: `packages/quant-core/risk/balkema_de_haan_pickands.py`
...
The fundamental relationship for **Balkema-de Haan-Pickands Theorem for POT GPD Exceedances** is governed by the operator:
