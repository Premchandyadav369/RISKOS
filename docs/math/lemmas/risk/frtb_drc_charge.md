# Mathematical Lemma: Basel III FRTB Default Risk Charge (DRC) Jump-to-Default
...
**Engine Ref**: `packages/quant-core/risk/frtb_drc_charge.py`
...
The fundamental relationship for **Basel III FRTB Default Risk Charge (DRC) Jump-to-Default** is governed by the operator:
