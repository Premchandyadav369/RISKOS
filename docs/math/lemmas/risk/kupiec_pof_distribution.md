# Mathematical Lemma: Kupiec POF Test Statistic Asymptotic Chi-Square Convergence
...
**Engine Ref**: `packages/quant-core/risk/kupiec_pof_distribution.py`
...
The fundamental relationship for **Kupiec POF Test Statistic Asymptotic Chi-Square Convergence** is governed by the operator:
