# Mathematical Lemma: Cornish-Fisher Quantile Expansion via Edgeworth Series
...
**Engine Ref**: `packages/quant-core/risk/cornish_fisher_expansion.py`
...
The fundamental relationship for **Cornish-Fisher Quantile Expansion via Edgeworth Series** is governed by the operator:
