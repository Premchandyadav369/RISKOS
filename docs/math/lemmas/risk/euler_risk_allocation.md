# Mathematical Lemma: Euler Homogeneity Theorem for Marginal Risk Attribution
...
**Engine Ref**: `packages/quant-core/risk/euler_risk_allocation.py`
...
The fundamental relationship for **Euler Homogeneity Theorem for Marginal Risk Attribution** is governed by the operator:
