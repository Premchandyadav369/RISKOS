# Mathematical Lemma: Adrian-Brunnermeier Quantile Regression Delta-CoVaR
...
**Engine Ref**: `packages/quant-core/risk/adrian_brunnermeier_covar.py`
...
The fundamental relationship for **Adrian-Brunnermeier Quantile Regression Delta-CoVaR** is governed by the operator:
