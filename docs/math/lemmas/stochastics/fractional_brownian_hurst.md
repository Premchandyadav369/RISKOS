# Mathematical Lemma: Mandelbrot Long-Range Dependence and Hurst Exponent

**Category**: Stochastic Calculus & Diffusion Theory  
**Classification**: Formal Quantitative Specification & Mathematical Invariant  
**Engine Ref**: `packages/quant-core/stochastics/fractional_brownian_hurst.py`
...
The fundamental relationship for **Mandelbrot Long-Range Dependence and Hurst Exponent** is governed by the operator:
