# Mathematical Lemma: Tanaka's Formula and Local Time of Brownian Motion

**Category**: Stochastic Calculus & Diffusion Theory  
**Classification**: Formal Quantitative Specification & Mathematical Invariant  
**Engine Ref**: `packages/quant-core/stochastics/tanaka_formula.py`
...
The fundamental relationship for **Tanaka's Formula and Local Time of Brownian Motion** is governed by the operator:
