# Mathematical Lemma: Feller Condition and Non-Central Chi-Square Law in CIR Process

**Category**: Stochastic Calculus & Diffusion Theory  
**Classification**: Formal Quantitative Specification & Mathematical Invariant  
**Engine Ref**: `packages/quant-core/stochastics/cir_feller_condition.py`
...
The fundamental relationship for **Feller Condition and Non-Central Chi-Square Law in CIR Process** is governed by the operator:
