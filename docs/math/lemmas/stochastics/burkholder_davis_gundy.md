# Mathematical Lemma: Burkholder-Davis-Gundy Inequalities for Submartingales

**Category**: Stochastic Calculus & Diffusion Theory  
**Classification**: Formal Quantitative Specification & Mathematical Invariant  
**Engine Ref**: `packages/quant-core/stochastics/burkholder_davis_gundy.py`
...
The fundamental relationship for **Burkholder-Davis-Gundy Inequalities for Submartingales** is governed by the operator:
