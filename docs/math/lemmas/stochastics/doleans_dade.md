# Mathematical Lemma: Dolleans-Dade Exponential of Continuous Semimartingales

**Category**: Stochastic Calculus & Diffusion Theory  
**Classification**: Formal Quantitative Specification & Mathematical Invariant  
**Engine Ref**: `packages/quant-core/stochastics/doleans_dade.py`
...
The fundamental relationship for **Dolleans-Dade Exponential of Continuous Semimartingales** is governed by the operator:
