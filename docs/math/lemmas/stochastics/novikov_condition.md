# Mathematical Lemma: Novikov's Condition for Exponential Martingales

**Category**: Stochastic Calculus & Diffusion Theory  
**Classification**: Formal Quantitative Specification & Mathematical Invariant  
**Engine Ref**: `packages/quant-core/stochastics/novikov_condition.py`
...
The fundamental relationship for **Novikov's Condition for Exponential Martingales** is governed by the operator:
