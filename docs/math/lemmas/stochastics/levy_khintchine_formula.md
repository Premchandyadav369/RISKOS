# Mathematical Lemma: Lévy-Khintchine Representation for Jump Generators

**Category**: Stochastic Calculus & Diffusion Theory  
**Classification**: Formal Quantitative Specification & Mathematical Invariant  
**Engine Ref**: `packages/quant-core/stochastics/levy_khintchine_formula.py`
...
The fundamental relationship for **Lévy-Khintchine Representation for Jump Generators** is governed by the operator:
