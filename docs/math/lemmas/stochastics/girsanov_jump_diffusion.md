# Mathematical Lemma: Girsanov Measure Transformation with Compound Poisson Jumps

**Category**: Stochastic Calculus & Diffusion Theory  
**Classification**: Formal Quantitative Specification & Mathematical Invariant  
**Engine Ref**: `packages/quant-core/stochastics/girsanov_jump_diffusion.py`
...
The fundamental relationship for **Girsanov Measure Transformation with Compound Poisson Jumps** is governed by the operator:
