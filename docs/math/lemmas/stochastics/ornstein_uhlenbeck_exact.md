# Mathematical Lemma: Exact Transition Density of Ornstein-Uhlenbeck Process

**Category**: Stochastic Calculus & Diffusion Theory  
**Classification**: Formal Quantitative Specification & Mathematical Invariant  
**Engine Ref**: `packages/quant-core/stochastics/ornstein_uhlenbeck_exact.py`
...
The fundamental relationship for **Exact Transition Density of Ornstein-Uhlenbeck Process** is governed by the operator:
