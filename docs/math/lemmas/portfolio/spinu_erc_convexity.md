# Mathematical Lemma: Spinu Coordinate Descent and Strictly Convex Log-Barrier for ERC
...
**Engine Ref**: `packages/quant-core/portfolio/spinu_erc_convexity.py`
...
The fundamental relationship for **Spinu Coordinate Descent and Strictly Convex Log-Barrier for ERC** is governed by the operator:
