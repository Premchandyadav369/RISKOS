# Mathematical Lemma: Jegadeesh-Titman Cross-Sectional Momentum Alpha Loading
...
**Engine Ref**: `packages/quant-core/portfolio/carhart_momentum_factor.py`
...
The fundamental relationship for **Jegadeesh-Titman Cross-Sectional Momentum Alpha Loading** is governed by the operator:
