# Mathematical Lemma: Fama-MacBeth Two-Pass Cross-Sectional Regression Consistency
...
**Engine Ref**: `packages/quant-core/portfolio/fama_macbeth_two_pass.py`
...
The fundamental relationship for **Fama-MacBeth Two-Pass Cross-Sectional Regression Consistency** is governed by the operator:
