# Mathematical Lemma: Theil Mixed Estimation Equivalence to Black-Litterman Posterior
...
**Engine Ref**: `packages/quant-core/portfolio/black_litterman_theil.py`
...
The fundamental relationship for **Theil Mixed Estimation Equivalence to Black-Litterman Posterior** is governed by the operator:
