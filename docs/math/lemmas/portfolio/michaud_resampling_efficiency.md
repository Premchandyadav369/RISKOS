# Mathematical Lemma: Michaud Resampled Efficient Frontier Monte Carlo Averaging
...
**Engine Ref**: `packages/quant-core/portfolio/michaud_resampling_efficiency.py`
...
The fundamental relationship for **Michaud Resampled Efficient Frontier Monte Carlo Averaging** is governed by the operator:
