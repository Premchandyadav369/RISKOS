# Mathematical Lemma: Merton Continuous Time Fractional Kelly Log-Wealth Optimization

**Category**: Portfolio Optimization & Matrix Regularization  
**Classification**: Formal Quantitative Specification & Mathematical Invariant  
**Engine Ref**: `packages/quant-core/portfolio/kelly_fractional_log_utility.py`
...
The fundamental relationship for **Merton Continuous Time Fractional Kelly Log-Wealth Optimization** is governed by the operator:
