# Mathematical Lemma: Markowitz Critical Line Algorithm Active Set Transitions
...
**Engine Ref**: `packages/quant-core/portfolio/markowitz_cla_derivation.py`
...
The fundamental relationship for **Markowitz Critical Line Algorithm Active Set Transitions** is governed by the operator:
