# Mathematical Lemma: Choueifaty Maximum Diversification Portfolio Optimality
...
**Engine Ref**: `packages/quant-core/portfolio/maximum_diversification_ratio.py`
...
The fundamental relationship for **Choueifaty Maximum Diversification Portfolio Optimality** is governed by the operator:
