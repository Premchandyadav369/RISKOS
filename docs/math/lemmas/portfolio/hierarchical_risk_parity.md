# Mathematical Lemma: De Prado Hierarchical Tree Clustering Covariance Allocation
...
**Engine Ref**: `packages/quant-core/portfolio/hierarchical_risk_parity.py`
...
The fundamental relationship for **De Prado Hierarchical Tree Clustering Covariance Allocation** is governed by the operator:
