# Mathematical Lemma: Exact Zero Coupon Bond Prices in Vasicek Affine Term Structure

**Category**: Interest Rate Curves & Sovereign Dynamics  
**Classification**: Formal Quantitative Specification & Mathematical Invariant  
**Engine Ref**: `packages/quant-core/fixed_income/vasicek_yield_curve.py`
...
The fundamental relationship for **Exact Zero Coupon Bond Prices in Vasicek Affine Term Structure** is governed by the operator:
