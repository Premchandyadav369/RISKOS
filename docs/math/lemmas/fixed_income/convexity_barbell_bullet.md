# Mathematical Lemma: Convexity Advantage of Barbell Portfolios over Bullet Bonds

**Category**: Interest Rate Curves & Sovereign Dynamics  
**Classification**: Formal Quantitative Specification & Mathematical Invariant  
**Engine Ref**: `packages/quant-core/fixed_income/convexity_barbell_bullet.py`
...
The fundamental relationship for **Convexity Advantage of Barbell Portfolios over Bullet Bonds** is governed by the operator:
