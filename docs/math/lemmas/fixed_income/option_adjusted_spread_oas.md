# Mathematical Lemma: Monte Carlo OAS Extraction from Callable Bond Trees

**Category**: Interest Rate Curves & Sovereign Dynamics  
**Classification**: Formal Quantitative Specification & Mathematical Invariant  
**Engine Ref**: `packages/quant-core/fixed_income/option_adjusted_spread_oas.py`
...
The fundamental relationship for **Monte Carlo OAS Extraction from Callable Bond Trees** is governed by the operator:
