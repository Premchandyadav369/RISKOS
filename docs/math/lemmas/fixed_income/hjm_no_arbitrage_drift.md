# Mathematical Lemma: Heath-Jarrow-Morton Forward Rate No-Arbitrage Drift Condition

**Category**: Interest Rate Curves & Sovereign Dynamics  
**Classification**: Formal Quantitative Specification & Mathematical Invariant  
**Engine Ref**: `packages/quant-core/fixed_income/hjm_no_arbitrage_drift.py`
...
The fundamental relationship for **Heath-Jarrow-Morton Forward Rate No-Arbitrage Drift Condition** is governed by the operator:
