# Mathematical Lemma: Zero-Volatility Spread Bootstrapping from Discount Curve

**Category**: Interest Rate Curves & Sovereign Dynamics  
**Classification**: Formal Quantitative Specification & Mathematical Invariant  
**Engine Ref**: `packages/quant-core/fixed_income/z_spread_interpolation.py`
...
The fundamental relationship for **Zero-Volatility Spread Bootstrapping from Discount Curve** is governed by the operator:
