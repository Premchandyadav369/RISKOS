# Mathematical Lemma: Key Rate Duration Partial DV01 Hedging Linear System

**Category**: Interest Rate Curves & Sovereign Dynamics  
**Classification**: Formal Quantitative Specification & Mathematical Invariant  
**Engine Ref**: `packages/quant-core/fixed_income/key_rate_duration_hadj.py`
...
The fundamental relationship for **Key Rate Duration Partial DV01 Hedging Linear System** is governed by the operator:
