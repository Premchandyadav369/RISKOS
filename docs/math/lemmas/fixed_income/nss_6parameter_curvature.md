# Mathematical Lemma: Nelson-Siegel-Svensson Extended Dual Hump Asymptotics

**Category**: Interest Rate Curves & Sovereign Dynamics  
**Classification**: Formal Quantitative Specification & Mathematical Invariant  
**Engine Ref**: `packages/quant-core/fixed_income/nss_6parameter_curvature.py`
...
The fundamental relationship for **Nelson-Siegel-Svensson Extended Dual Hump Asymptotics** is governed by the operator:
