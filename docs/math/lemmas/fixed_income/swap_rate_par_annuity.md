# Mathematical Lemma: Par Swap Rate Derivation from Forward Discount Factors

**Category**: Interest Rate Curves & Sovereign Dynamics  
**Classification**: Formal Quantitative Specification & Mathematical Invariant  
**Engine Ref**: `packages/quant-core/fixed_income/swap_rate_par_annuity.py`
...
The fundamental relationship for **Par Swap Rate Derivation from Forward Discount Factors** is governed by the operator:
