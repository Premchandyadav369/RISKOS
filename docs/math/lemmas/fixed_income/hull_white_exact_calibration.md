# Mathematical Lemma: Exact Yield Curve Calibration in Hull-White Extended Model

**Category**: Interest Rate Curves & Sovereign Dynamics  
**Classification**: Formal Quantitative Specification & Mathematical Invariant  
**Engine Ref**: `packages/quant-core/fixed_income/hull_white_exact_calibration.py`
...
The fundamental relationship for **Exact Yield Curve Calibration in Hull-White Extended Model** is governed by the operator:
